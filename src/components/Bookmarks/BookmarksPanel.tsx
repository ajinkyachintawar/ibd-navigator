...
const PIN_LABEL: Record<string, string> = { toilet: 'WC', pharmacy: 'Rx', hospital: 'H', restaurant: 'R' }
const PIN_COLOUR: Record<string, string> = { toilet: '#15803d', pharmacy: '#7c3aed', hospital: '#2563eb', restaurant: '#c2410c' }
                ...
                <li key={b.localId}>
                  ...
                  >
                    <span
                      ...
                      style={{ background: PIN_COLOUR[b.category] ?? '#0f766e' }}
                    >
